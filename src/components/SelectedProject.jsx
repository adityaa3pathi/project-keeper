...
export default function SelectedProject({project, onDeleteTask, onAdd, tasks}) {
        ...
        <div className="w-[35rem] mt-16 pl-8">
            <header className="pb-4 mb-4 border-b-2 border-slate-300" >
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold text-slate-600 mb-2">{project.title}</h1>
                    <button className="text-stone-600 hover:text-slate950"
